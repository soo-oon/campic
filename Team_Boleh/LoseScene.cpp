...
void LoseScene::Initialize()
{
    ...
    m_game_over->SetScale({ static_cast<float>(Application_.GetGLFWvidmode()->width), static_cast<float>(Application_.GetGLFWvidmode()->height) });
    ...
    m_restart->SetTranslation({ Application_.GetScreenSize().x / 2, -Application_.GetScreenSize().y / 2 });
    ...
    m_menu = new Object();
    m_menu->SetTranslation({ Application_.GetScreenSize().x / 2, -Application_.GetScreenSize().y / 2 });
